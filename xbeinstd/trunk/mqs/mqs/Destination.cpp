...
Destination::Destination(const Destination& dst) {
  assign(dst.str());
}

Destination::Destination(const cms::Destination* dst) {
  assign(dst);
}

void
Destination::assign(const std::string& newDestination) throw() {
  try {
...
void
Destination::assign(const cms::Destination* newDestination) throw() {
  try {
