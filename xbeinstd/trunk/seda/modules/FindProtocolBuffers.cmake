...
IF( NOT $ENV{PB_HOME} STREQUAL "" )
    SET(_pb_INCLUDE_SEARCH_DIRS $ENV{PB_HOME}/include ${_pb_INCLUDE_SEARCH_DIRS})
    SET(_pb_LIBRARIES_SEARCH_DIRS $ENV{PB_HOME}/lib ${_pb_INCLUDE_SEARCH_DIRS})
    SET(_pb_HOME $ENV{PB_HOME})
  ENDIF( NOT $ENV{PB_HOME} STREQUAL "" )
  ...
  IF( NOT $ENV{PB_LIBRARYDIR} STREQUAL "" )
    SET(_pb_LIBRARIES_SEARCH_DIRS $ENV{PB_LIBRARYDIR} ${_pb_INCLUDE_SEARCH_DIRS})
