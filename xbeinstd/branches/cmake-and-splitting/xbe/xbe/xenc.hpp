...
#ifndef CXX_U_HPC_PETRY_SRC_XBEINSTD_BRANCHES_CMAKE_AND_SPLITTING_XBE_ETC_XBE_SCHEMA_XENC_HPP
#define CXX_U_HPC_PETRY_SRC_XBEINSTD_BRANCHES_CMAKE_AND_SPLITTING_XBE_ETC_XBE_SCHEMA_XENC_HPP
...
namespace xenc
{
  class EncryptedType: public ::xml_schema::type
  {
    ...
    // EncryptionMethod
    // 
    typedef ::xenc::EncryptionMethodType EncryptionMethod_type;
    typedef ::xsd::cxx::tree::optional< EncryptionMethod_type > EncryptionMethod_optional;
    typedef ::xsd::cxx::tree::traits< EncryptionMethod_type, char > EncryptionMethod_traits;
    ...
    // CipherData
    // 
    typedef ::xenc::CipherDataType CipherData_type;
    typedef ::xsd::cxx::tree::traits< CipherData_type, char > CipherData_traits;
    ...
    // 
    typedef ::xenc::EncryptionPropertiesType EncryptionProperties_type;
    typedef ::xsd::cxx::tree::optional< EncryptionProperties_type > EncryptionProperties_optional;
    typedef ::xsd::cxx::tree::traits< EncryptionProperties_type, char > EncryptionProperties_traits;
  ...
  class EncryptionMethodType: public ::xml_schema::type
  {
    ...
    // KeySize
    // 
    typedef ::xenc::KeySizeType KeySize_type;
    typedef ::xsd::cxx::tree::optional< KeySize_type > KeySize_optional;
    typedef ::xsd::cxx::tree::traits< KeySize_type, char > KeySize_traits;
    ...
    typedef ::xsd::cxx::tree::traits< OAEPparams_type, char > OAEPparams_traits;
  ...
  class KeySizeType: public ::xsd::cxx::tree::fundamental_base< ::xml_schema::integer, char, ::xml_schema::simple_type >
  {
    public:
    // Constructors.
    //
  ...
  class CipherDataType: public ::xml_schema::type
  {
    ...
    typedef ::xsd::cxx::tree::traits< CipherValue_type, char > CipherValue_traits;
    ...
    // CipherReference
    // 
    typedef ::xenc::CipherReferenceType CipherReference_type;
    typedef ::xsd::cxx::tree::optional< CipherReference_type > CipherReference_optional;
    typedef ::xsd::cxx::tree::traits< CipherReference_type, char > CipherReference_traits;
  ...
  class CipherReferenceType: public ::xml_schema::type
  {
    ...
    // Transforms
    // 
    typedef ::xenc::TransformsType Transforms_type;
  ...
  class EncryptedDataType: public ::xenc::EncryptedType
  {
    public:
    // Constructors.
    //
  ...
  class EncryptedKeyType: public ::xenc::EncryptedType
  {
    public:
    // ReferenceList
    // 
    typedef ::xenc::ReferenceList ReferenceList_type;
    typedef ::xsd::cxx::tree::optional< ReferenceList_type > ReferenceList_optional;
    typedef ::xsd::cxx::tree::traits< ReferenceList_type, char > ReferenceList_traits;
    ...
    typedef ::xsd::cxx::tree::traits< CarriedKeyName_type, char > CarriedKeyName_traits;
    ...
    typedef ::xsd::cxx::tree::traits< Recipient_type, char > Recipient_traits;
  ...
  class AgreementMethodType: public ::xml_schema::type
  {
    ...
    typedef ::xsd::cxx::tree::traits< KA_Nonce_type, char > KA_Nonce_traits;
    ...
    typedef ::xsd::cxx::tree::traits< OriginatorKeyInfo_type, char > OriginatorKeyInfo_traits;
    ...
    // RecipientKeyInfo
    // 
    typedef ::dsig::KeyInfoType RecipientKeyInfo_type;
    typedef ::xsd::cxx::tree::optional< RecipientKeyInfo_type > RecipientKeyInfo_optional;
    typedef ::xsd::cxx::tree::traits< RecipientKeyInfo_type, char > RecipientKeyInfo_traits;
  ...
  class EncryptionPropertiesType: public ::xml_schema::type
  {
    ...
    // EncryptionProperty
    // 
    typedef ::xenc::EncryptionPropertyType EncryptionProperty_type;
    ...
    typedef ::xsd::cxx::tree::traits< EncryptionProperty_type, char > EncryptionProperty_traits;
  ...
  class ReferenceList: public ::xml_schema::type
  {
    ...
    // DataReference
    // 
    typedef ::xenc::ReferenceType DataReference_type;
    ...
    typedef ::xsd::cxx::tree::traits< DataReference_type, char > DataReference_traits;
    ...
    // KeyReference
    // 
    typedef ::xenc::ReferenceType KeyReference_type;
    ...
    typedef ::xsd::cxx::tree::traits< KeyReference_type, char > KeyReference_traits;
...
namespace xenc
{
  ...
  CipherData (const ::std::string& uri,
              ::xml_schema::flags f = 0,
  ...
  CipherReference (const ::std::string& uri,
                   ::xml_schema::flags f = 0,
                   const ::xml_schema::properties& p = ::xml_schema::properties ());
  ...
  EncryptedData (const ::std::string& uri,
                 ::xml_schema::flags f = 0,
                 const ::xml_schema::properties& p = ::xml_schema::properties ());
  ...
  EncryptedKey (const ::std::string& uri,
                ::xml_schema::flags f = 0,
                const ::xml_schema::properties& p = ::xml_schema::properties ());
  ...
  AgreementMethod (const ::std::string& uri,
                   ::xml_schema::flags f = 0,
                   const ::xml_schema::properties& p = ::xml_schema::properties ());
  ...
  ReferenceList_ (const ::std::string& uri,
                  ::xml_schema::flags f = 0,
                  const ::xml_schema::properties& p = ::xml_schema::properties ());
  ...
  EncryptionProperties (const ::std::string& uri,
                        ::xml_schema::flags f = 0,
                        const ::xml_schema::properties& p = ::xml_schema::properties ());
  ...
  EncryptionProperty (const ::std::string& uri,
                      ::xml_schema::flags f = 0,
                      const ::xml_schema::properties& p = ::xml_schema::properties ());
...
namespace xenc
{
  ...
  CipherData (const ::xenc::CipherDataType& x, 
              const ::xml_schema::namespace_infomap& m,
              ::xml_schema::flags f = 0);
  ...
  CipherReference (::std::ostream& os,
                   const ::xenc::CipherReferenceType& x, 
                   const ::xml_schema::namespace_infomap& m,
                   const ::std::string& e = "UTF-8",
                   ::xml_schema::flags f = 0);
  ...
  ::xml_schema::dom::auto_ptr< ::xercesc::DOMDocument >
  CipherReference (const ::xenc::CipherReferenceType& x, 
                   const ::xml_schema::namespace_infomap& m,
                   ::xml_schema::flags f = 0);
  ...
  EncryptedData (::std::ostream& os,
                 const ::xenc::EncryptedDataType& x, 
                 const ::xml_schema::namespace_infomap& m,
                 const ::std::string& e = "UTF-8",
                 ::xml_schema::flags f = 0);
  ...
  ::xml_schema::dom::auto_ptr< ::xercesc::DOMDocument >
  EncryptedData (const ::xenc::EncryptedDataType& x, 
                 const ::xml_schema::namespace_infomap& m,
                 ::xml_schema::flags f = 0);
  ...
  ::xml_schema::dom::auto_ptr< ::xercesc::DOMDocument >
  EncryptedKey (const ::xenc::EncryptedKeyType& x, 
                const ::xml_schema::namespace_infomap& m,
                ::xml_schema::flags f = 0);
  ...
  AgreementMethod (::std::ostream& os,
                   const ::xenc::AgreementMethodType& x, 
                   const ::xml_schema::namespace_infomap& m,
                   const ::std::string& e = "UTF-8",
                   ::xml_schema::flags f = 0);
  ...
  ::xml_schema::dom::auto_ptr< ::xercesc::DOMDocument >
  AgreementMethod (const ::xenc::AgreementMethodType& x, 
                   const ::xml_schema::namespace_infomap& m,
                   ::xml_schema::flags f = 0);
  ...
  ::xml_schema::dom::auto_ptr< ::xercesc::DOMDocument >
  ReferenceList_ (const ::xenc::ReferenceList& x, 
                  const ::xml_schema::namespace_infomap& m,
                  ::xml_schema::flags f = 0);
  ...
  EncryptionProperties (::std::ostream& os,
                        const ::xenc::EncryptionPropertiesType& x, 
                        const ::xml_schema::namespace_infomap& m,
                        const ::std::string& e = "UTF-8",
                        ::xml_schema::flags f = 0);
  ...
  ::xml_schema::dom::auto_ptr< ::xercesc::DOMDocument >
  EncryptionProperties (const ::xenc::EncryptionPropertiesType& x, 
                        const ::xml_schema::namespace_infomap& m,
                        ::xml_schema::flags f = 0);
  ...
  EncryptionProperty (::std::ostream& os,
                      const ::xenc::EncryptionPropertyType& x, 
                      const ::xml_schema::namespace_infomap& m,
                      const ::std::string& e = "UTF-8",
                      ::xml_schema::flags f = 0);
  ...
  ::xml_schema::dom::auto_ptr< ::xercesc::DOMDocument >
  EncryptionProperty (const ::xenc::EncryptionPropertyType& x, 
                      const ::xml_schema::namespace_infomap& m,
                      ::xml_schema::flags f = 0);
...
#endif // CXX_U_HPC_PETRY_SRC_XBEINSTD_BRANCHES_CMAKE_AND_SPLITTING_XBE_ETC_XBE_SCHEMA_XENC_HPP
