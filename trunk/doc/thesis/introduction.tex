...
The proposed \emph{Xen-Eased Execution Environment} addresses this problem
by allowing an user to  ``execute'' a complete machine image --- therefore
any user application can be executed.
